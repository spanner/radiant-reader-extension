...
# This test goes unchanged from previous version of plugin by technoweenie,
# that was implemented as a Rails helper module. It wasn't changed even slightest
# bit to ensure backward compatibility.
class WhiteListHelperTest < Test::Unit::TestCase
